...
- Read/Write Files: {"action": "file_system", "action_type": "write", "path": "test.txt", "content": "hello"} (action_types: read, write, list)
- Open Mac Terminal: {"action": "open_terminal"}
...
{"action": "file_system", "action_type": "write", "path": "file.txt", "content": "Data"}
